...
- **[SmartInboxTriage](./SmartInboxTriage)** — an always-on inbox agent, RAG-powered (Claude + Cohere + Supabase), that reads incoming email, replies from a knowledge base, and escalates to me over Telegram the moment it's genuinely unsure. [5 live test scenarios, videos included →](./SmartInboxTriage/case-study)
